    ...
    <div className="flex flex-col">
      <div className="bg-[var(--bg-surface)] px-4 py-6 flex items-center gap-3">
        <div className="flex items-center justify-center w-12 h-12 rounded-full bg-[var(--bg-elevated)]">
          <span className="text-base font-semibold text-[var(--accent-primary)]">–</span>
        </div>
        <div>
          <h1 className="text-lg font-bold text-[var(--text-primary)]">Mi Cuenta</h1>
          <p className="text-sm text-[var(--text-secondary)]">Inicia sesión para ver tus pedidos</p>
        </div>
      </div>
